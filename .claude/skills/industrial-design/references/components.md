...
Each component references Material 3 composables where possible; custom composables only when M3 doesn't fit the aesthetic (segmented progress bar, stat row, instrument gauge).
